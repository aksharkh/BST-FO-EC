...
const defaultOptions: HyperspeedOptions = {
  ...
  colors: {
    roadColor: 0x85E689,
    islandColor: 0xEAFF00,
    background: 0x000000,
    shoulderLines: 0x4DFFC9,
    brokenLines: 0x05B510,
    leftCars: [0x4DFFC9, 0xEAFF00, 0x00FF85],
    rightCars: [0x4DFFC9, 0xEAFF00, 0x00FF85],
    sticks: 0xEAFF00
  }
};
...
const Hyperspeed: FC<HyperspeedProps> = ({ effectOptions = DEFAULT_EFFECT_OPTIONS }) => {
  ...
  const memoOptions = useMemo(() => effectOptions, [JSON.stringify(effectOptions)]);
  ...
  useEffect(() => {
    ...
    const options: HyperspeedOptions = {
      ...defaultOptions,
      ...memoOptions,
      colors: { ...defaultOptions.colors, ...memoOptions.colors }
    };
  ...
  return <div id="lights" className="absolute inset-0 w-full h-full overflow-hidden block" ref={hyperspeed}></div>;
};
